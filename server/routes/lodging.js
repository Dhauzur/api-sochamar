...
lodgingRouter.delete('/lodging/delete/company/:id', lodgingController.deleteOneWithCompanyId);
lodgingRouter.delete('/lodging/delete/all', lodgingController.deleteAll);
lodgingRouter.delete('/lodging/delete/companies/:company', lodgingController.deleteAllWithCompany);
